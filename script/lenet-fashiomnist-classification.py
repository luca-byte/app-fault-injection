...
log = f"FMNIST/L{layer}-{index}/log/LeNet.log"
wdir = f"FMNIST/L{layer}-{index}"
seed = None
device = torch.device("cuda")
dataset = torchvision.datasets.FashionMNIST(
    "~/dataset/fmnist", transform=transformer, download=True
)
model_path = "FMNIST/LeNet_FashionMNIST.pth"
...
pre_path = "FMNIST/FashionMNIST-1.json"

feat_ex = Preprocessing.load(pre_path, use_scaler=True)

ext_clf = ModelTrainer.load("FMNIST/Classifier-FashionMNIST-1.pth", 35, 10)
